    ...
    <div class="container">
        ...
        <form class="form-horizontal" name='identification' method="post" action="OeuvreventeController?action=add">
            <div class="form-group">
                <label class="control-label col-sm-2" for="nom">Titre de l'oeuvre :</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="txttitre" id="txttitre" placeholder="Entrez le titre ..." value="" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="nom">Prix de l'oeuvre :</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="numberprix" id="numberprix" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="nom">Proprietaire de l'oeuvre :</label>
                <div class="col-sm-10">
